...
| **Skill 수** | 10개 (AI-DLC 핵심만) | 23개 (일상 개발 도구 포함) |
...
3. **requirements-analysis** — 적응형 깊이(Minimal / Standard / Comprehensive) 요구사항 분석
...
| `requirements-analysis` | 적응형 요구사항 분석 (순수 실행) |
